  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row py-5">
      <div className="w-full lg:w-1/2 p-6 flex flex-col gap-8">
        ...
        <form action="#" className="flex flex-col gap-4 w-full lg:w-3/4 mx-auto">
        ...
        <Link to='/register' className="flex border-2 w-1/4 mx-auto justify-center p-2 rounded-full border-[#b67352]">
          Sign Up now
        </Link>
      </div>
